...
try:
    from workspace_integrations import create_google_doc
except ImportError:
...
tools = [search_atena_knowledge_base, search_live_internet, generate_legal_document, send_communication_tool, create_google_workspace_doc]
...
def agent_node(state: AgentState):
    ...
    Hai a disposizione CINQUE strumenti principali:
...
def main():
    print("====================================================")
    print("⚖️ ATENA OMNISCIENCE: Multi-Tool Agent ⚖️")
    print("====================================================\n")
                ...
                for node_name, node_state in event.items():
                    if "messages" in node_state and len(node_state["messages"]) > 0:
                        ...
                        if node_name == "agent" and isinstance(msg, AIMessage) and not msg.tool_calls:
                           ...
                           print(f"\n[⚠️ REJECT]: Atena rielabora la risposta in base ai fatti reali.")
